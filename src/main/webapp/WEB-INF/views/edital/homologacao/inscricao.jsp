			...
			<div data-loading-container="tableParams.settings().$loading">
				<table data-ng-table="tableParams" class="mdl-data-table mdl-js-data-table mdl-shadow--2dp wide paginated" style="font-size: 12px"> 
					<tr data-ng-repeat="item in $data"> 
						...
						<td class="mdl-data-table__cell--non-numeric" header-class="'text-left'" data-title="'<spring:message code='edital.homologacao.inscricao.table.homologado.inicial'/>'" data-ng-click="ctrl.homologar(item.id, 'selecao')">
						...
						<td class="mdl-data-table__cell--non-numeric" header-class="'text-left'" data-title="'<spring:message code='edital.homologacao.inscricao.table.homologado.recurso'/>'" data-ng-click="ctrl.homologar(item.id, 'recurso')">
							<input class="" type="checkbox" name="group" id="{{item.id}}" />
						</td>
						<td class="mdl-data-table__cell--non-numeric" header-class="'text-left'" data-title="'<spring:message code='edital.homologacao.inscricao.table.homologado.justificativa'/>'">
							<input class="" type="text" name="group" id="{{item.id}}" />
